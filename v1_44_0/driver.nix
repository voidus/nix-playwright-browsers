...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "playwright";
    rev = "v${version}";
    hash = "sha256-KDR8mmiQfjCVm6ybQ6zTmlNnyyXO8MgqV1kC44PhPsU=";
  };
  ...
  babel-bundle = buildNpmPackage {
    ...
    npmDepsHash = "sha256-A1hfMfNSYKF/VvsspOvioFy82Yin3/JhcdabsQj47Wk=";
    dontNpmBuild = true;
    installPhase = ''
      cp -r . "$out"
    '';
  ...
  playwright = buildNpmPackage {
    ...
    npmDepsHash = "sha256-RkGQbH8Ainw5zAW6Uqx+C9iCUgfLVFL6SpO8KvnQlw0=";
