...
let
  ...
  src = fetchFromGitHub {
    ...
    repo = "playwright";
    rev = "v${version}";
    hash = "sha256-cp/GL2buU82wXWSPwiSLaDNVcfSkDYj12/mqJeej+88=";
  };
  ...
  utils-bundle = buildNpmPackage {
    ...
    npmDepsHash = "sha256-4MdHy02VaJASvZJkVL8iTN1MkpWABAKPEvRWjgjSxbQ=";
    dontNpmBuild = true;
    installPhase = ''
      cp -r . "$out"
    '';
  ...
  utils-bundle-core = buildNpmPackage {
    ...
    npmDepsHash = "sha256-465oiybF6iz0eEuUg8p907aiSz36gjj0MM0OcQuYdZs=";
    dontNpmBuild = true;
    installPhase = ''
      cp -r . "$out"
    '';
  ...
  playwright = buildNpmPackage {
    ...
    npmDepsHash = "sha256-AQupJPAb00fHC4JUgMENJqgGhZcGOUkW6m29D+7EoFs=";
